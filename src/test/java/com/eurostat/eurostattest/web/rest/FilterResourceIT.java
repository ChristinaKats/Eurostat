...
class FilterResourceIT {
    ...
    public static Filter createEntity(EntityManager em) {
        Filter filter = new Filter().configuration(DEFAULT_CONFIGURATION);
        return filter;
    }
    ...
    public static Filter createUpdatedEntity(EntityManager em) {
        Filter filter = new Filter().configuration(UPDATED_CONFIGURATION);
        return filter;
    }
    ...
    void createFilter() throws Exception {
        ...
        assertThat(testFilter.getConfiguration()).isEqualTo(DEFAULT_CONFIGURATION);
    }
    ...
    void putNewFilter() throws Exception {
        ...
        Filter testFilter = filterList.get(filterList.size() - 1);
        assertThat(testFilter.getConfiguration()).isEqualTo(UPDATED_CONFIGURATION);
    }
    ...
    void fullUpdateFilterWithPatch() throws Exception {
        ...
        partialUpdatedFilter.configuration(UPDATED_CONFIGURATION);
